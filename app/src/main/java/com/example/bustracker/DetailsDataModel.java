...
public class DetailsDataModel {
    public String name="",email="",id="",boardingPoint="",feeStructure="",phoneNo="",numberPlate,year="",dept="",busNo="",isFeePaid="",passValidFrom="",passValidTill="";
    ...
    public DetailsDataModel(String nameStr,String email,String phoneNo,String boardingPointStr,String id,String numberPlate){
        this.name = nameStr;
        this.email = email;
        this.id = id;
        this.boardingPoint = boardingPointStr;
