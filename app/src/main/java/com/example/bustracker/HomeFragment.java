    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Menubtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(getContext(),"came",Toast.LENGTH_SHORT).show();
                DrawerView.more();
            }
        });
                        ...
                        if(!CollegeName.getText().toString().isEmpty()){
                            if(!BusNumber.getText().toString().isEmpty()) {
                                if (!Start.getText().toString().isEmpty()) {
                                    ...
                                    Toast.makeText(getContext(),"Start Route cannot be empty",Toast.LENGTH_SHORT).show();
                                }
                            }
                            else{
                                Toast.makeText(getContext(),"Student Id cannot be empty",Toast.LENGTH_SHORT).show();
                            }
                        }
                        else{
                            Toast.makeText(getContext(),"College Name cannot be empty",Toast.LENGTH_SHORT).show();
                        }
                    }
                });
                dialog.show();
